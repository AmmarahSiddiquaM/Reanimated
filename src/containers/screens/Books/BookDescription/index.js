...
import {PERSPECTIVE, SCREEN_WIDTH} from '../constants';
...
const BookShelf = ({translateX, onPressBack}) => {
  ...
  const pressableStyles = useAnimatedStyle(() => ({
    opacity: translateX.value === SCREEN_WIDTH ? withTiming(1) : withTiming(0),
    transform: [
      {
        translateX:
          translateX.value === SCREEN_WIDTH ? withTiming(0) : withTiming(20),
      },
    ],
  }));
        ...
        <View style={{flex: 1}}>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.titleContainer}>
              <FastImage source={images.books[1]} style={styles.image} />
